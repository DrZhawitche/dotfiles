...
awful.tag.add("V ", {
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", border_width = 1.5, border_color = "#293E47", screen = s })
...
--beautiful.bg_systray = "#121f29"

beautiful.wibar_border_color = "#434F55"
beautiful.tasklist_bg_focus = "#434F55"
--beautiful.tasklist_font = "Cantarell"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "e", function () awful.spawn(gui_texteditor) end,
        {description = "Open Gui Text Editor", group = "Applications"}),
    ...
    awful.key({ modkey, "Shift" }, "w", function () awful.spawn(browser2) end,
        {description = "Open browser", group = "Applications"}),
    awful.key({ modkey, "Shift" }, "e", function () awful.spawn("alacritty vim") end,
        {description = "Open editor", group = "Applications"}),
    awful.key({ }, "Print", function () awful.spawn("flameshot gui") end,
        {description = "Open screenshot utility", group = "Applications"}),
    awful.key({ modkey }, "o", function () awful.spawn("libreoffice") end,
        {description = "Open Libreoffice", group = "Applications"}),
    awful.key({ modkey, "Shift" }, "m", function () awful.spawn(music_player) end,
        {description = "Open music player", group = "Applications"}),
   ...
   awful.key({ modkey, }, "F5", function () awful.spawn("BRIGHTNESS=`xrandr --verbose | grep -i brightness | cut -f2 -d ' ' | head -n1` && xrandr --output HDMI-A-0 --brightness $((0.25 + $BRIGHTNESS))") end,
       {description = "Higher brightness", group = "screen"}),
